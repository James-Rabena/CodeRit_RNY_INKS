...
<body>
    ...
    <div class="container modern-container">
        ...
        <div class="modern-grid men-women">
            <div class="modern-card" onclick="redirectTo('sauvageamouage.php')">
            ...
            <div class="modern-card" onclick="redirectTo('maisonfrancisamouage.php')">
