...
// Fetch male Eau de Parfum products from the database
...
<head>
    ...
    <title>Fragrance Fusion - Tom Ford</title>
    <!-- Bootstrap 5.0.2 CSS -->
...
<div class="container mt-5">
    <h1 class="text-center modern-heading">Male Fragrances - Eau De Parfum</h1>
    ...
    <script>
        ...
        // Function to get cart count from localStorage for guests
