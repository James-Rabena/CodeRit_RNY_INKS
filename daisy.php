...
// Fetch female Eau de Toilette products from the database
...
<head>
    ...
    <title>Fragrance Fusion - Female Fragrances</title>
    <!-- Bootstrap 5.0.2 CSS -->
...
<div class="container mt-5">
    <h1 class="text-center modern-heading">Female Fragrances - Eau De Toilette</h1>
            ...
            if (isLoggedIn) {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        // Update cart count - REPLACE WITH THIS CODE
