...
// Get products for summer season - specifically the EF products for Summer5 page
$stmt = $conn->prepare("
    SELECT p.* FROM products p
    JOIN product_seasons ps ON p.id = ps.product_id
    JOIN seasons s ON ps.season_id = s.id
    WHERE s.name = 'Summer' AND p.id = 72
");
$stmt->execute();
...
<head>
    ...
    <title>Fragrance Fusion - Summer EF Collection</title>
...
<div class="container mt-5">
    <h1 class="text-center modern-heading">Summer Fragrances - Eau De Fraiche</h1>
