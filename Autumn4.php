...
// Get products for autumn season - specifically eau de cologne products
$stmt = $conn->prepare("
    SELECT p.* FROM products p
    JOIN product_seasons ps ON p.id = ps.product_id
    JOIN seasons s ON ps.season_id = s.id
    WHERE s.name = 'Autumn' AND p.category = 'eau de cologne'
");
$stmt->execute();
...
<head>
    ...
    <title>Fragrance Fusion - Autumn EDC Collection</title>
...
<div class="container mt-5">
    <h1 class="text-center modern-heading">Autumn Fragrances - Eau De Cologne</h1>
    <p class="text-center modern-subheading">Explore our selection of warm and refreshing fragrances perfect for the autumn season.</p>
        ...
        function addToCart(productData) {
            ...
            if (isLoggedIn) {
                ...
                try {
                    ...
                    // Calculate new cart count and update IMMEDIATELY
