...
// Fetch female cologne products from the database
$category = 'cologne';
$gender = 'female';
...
<head>
    ...
    <title>Fragrance Fusion - Women's Cologne</title>
    <!-- Bootstrap 5.0.2 CSS -->
...
<div class="container mt-5">
    <h1 class="text-center modern-heading">Female Fragrances - Eau De Cologne</h1>
    ...
    <script>
        ...
        // Add this function to get localStorage cart count
        ...
        // Enhanced updateCartBadge function
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Optional: Create toast container if it doesn't exist
        ...
        function addToCart(productData) {
            ...
            if (isLoggedIn) {
                ...
                try {
                    ...
                    // Calculate new cart count and update badge immediately
