...
// Fetch male Eau Fraiche products from the database
...
<div class="container mt-5">
    <h1 class="text-center modern-heading">Male Fragrances - Eau De Fraiche</h1>
    ...
    <script>
        ...
        function addToCart(productData) {
            ...
            if (isLoggedIn) {
                ...
                try {
                    ...
                    // Calculate new cart count IMMEDIATELY and update badge
        ...
        // Add this initialization code before the closing  tag
