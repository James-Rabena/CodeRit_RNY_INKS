...
// Fetch male Eau de Toilette products from the database
...
<head>
    ...
    <title>Fragrance Fusion - Male Fragrances</title>
    <!-- Bootstrap 5.0.2 CSS -->
...
<div class="container mt-5">
    <h1 class="text-center modern-heading">Male Fragrances - Eau De Toilette</h1>
    ...
    <script>
        ...
        let cartCount = <?php echo $cartCount; ?>; // Track cart count globally

        // Show notification function with working close button
        ...
        // Add this helper function to get localStorage cart count
            ...
            if (isLoggedIn) {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        // Update cart count - MODIFIED THIS SECTION
        ...
        // Add this to initialize cart for guests - place at the end of your script
        document.addEventListener('DOMContentLoaded', function() {
            if (!isLoggedIn) {
                // Initialize cart badge for guests from localStorage
