...
<head>
    ...
    <title>Eau De Fraiche Fragrances</title>
</head>
<body>
    ...
    <div class="container modern-container">
        ...
        <div class="modern-grid men-women">
            <div class="modern-card" onclick="redirectTo('eisenberg.php')">
                <img src="../assets/FORMEN4.jpg" alt="Male" class="modern-card-img">
                <div class="modern-card-body">
                    <h3 class="modern-card-title">Male</h3>
                    <p class="modern-card-text">Bold and sophisticated scents</p>
                </div>
            </div>
            <div class="modern-card" onclick="redirectTo('cucina.php')">
                <img src="../assets/FORWOMEN2.jpg" alt="Female" class="modern-card-img">
                <div class="modern-card-body">
